...
if commit_hash_short:
    release = version_number+"+"+commit_hash_short
else:
...
#html_title = 'pyautoupdate v0.0.1'
...
# pixels large.
html_favicon = "_static/images/pyautoupdate_logo_icon.ico"
...
htmlhelp_basename = 'pyautoupdatedoc'
...
latex_documents = [
    (master_doc, 'pyautoupdate.tex', 'pyautoupdate Documentation',
     'Ryan Lee', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyautoupdate', 'pyautoupdate Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyautoupdate', 'pyautoupdate Documentation',
     author, 'pyautoupdate', 'One line description of project.',
     'Miscellaneous'),
]
